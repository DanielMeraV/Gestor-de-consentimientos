...
const actualizarRegistroConsentimiento = async (req, res) => {
    try {
        ...
        // 🔥 Llamamos al procedimiento almacenado `sp_ActualizarRegistroConsentimiento`
        const [resultado] = await sequelize.query(
            `EXEC sp_ActualizarRegistroConsentimiento 
                @RegistroID = :id,
                @Aceptado = :Aceptado,
        ...
        console.log("✅ Registro actualizado correctamente:", resultado);
